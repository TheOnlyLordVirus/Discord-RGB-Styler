...
[
	...
	{ varName: "--text-normal", defaultCSS: "#dcddde", rainbowBool: false },
	{ varName: "--text-muted", defaultCSS: "#72767d", rainbowBool: false },
...
{	
	...
	start() 
	{
		...
		else 
		{
			...
			BdApi.saveData(this.getName(), "themeDark", currentSettings);
			console.log("RGB Styler: Settings Loaded!");
		}
	...
	getSettingsPanel() 
	{
		...
		header.innerHTML = "Choose Settings";
